class Admin::DistributorsController < Admin::ApplicationController
  ...
  def distributor_params
    distributor_params = params.require(:distributor).permit(:company_name, :first_name, :last_name, :tax_id, :email, :phone, :address1, :address2, :country, :city, :state, :zip, :price)
