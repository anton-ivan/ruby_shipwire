class Admin::OrdersController < Admin::ApplicationController
  ...
  def update_price
    ...
    if price
      price.update_attributes(:price=>params[:price].to_f, :recurrent_price=>params[:recurrent_price].to_f)
    else
      ProductPrice.create(:price=>params[:price].to_f, :recurrent_price=>params[:recurrent_price].to_f)
    end
  end
